...
@section('page-title', 'Add New Flat')
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Add New Flat</h3>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.flats.store') }}" method="POST">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="flat_number"
                            ...
                            value="{{ old('flat_number') }}" placeholder="e.g. A1, 101">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="flat_type"
                            ...
                            value="{{ old('flat_type') }}" placeholder="e.g. 2BHK, 3BHK">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="size_sqft"
                            ...
                            value="{{ old('size_sqft') }}" placeholder="e.g. 850">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="rent_amount"
                            ...
                            value="{{ old('rent_amount') }}" placeholder="e.g. 15000">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="electricity_meter_no"
                            ...
                            value="{{ old('electricity_meter_no') }}" placeholder="Enter meter number">
            ...
            <div class="mt-2">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save mr-1"></i> Save Flat
                </button>
