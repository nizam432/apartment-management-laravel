...
<form action="{{ route('admin.employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="building_id" class="form-control @error('building_id') is-invalid @enderror">
                            ...
                            @foreach($buildings as $building)
                                <option value="{{ $building->id }}" {{ old('building_id', $employee->building_id) == $building->id ? 'selected' : '' }}>
                                    {{ $building->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Resign Date <small class="text-muted">(Optional)</small></label>
                        ...
                        @error('resign_date') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                </div>
                        ...
                        @if($employee->photo)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $employee->photo) }}"
                                     alt="Photo" height="60" class="rounded">
                            </div>
                        @endif
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="payment_info" rows="2"
                            class="form-control @error('payment_info') is-invalid @enderror">{{ old('payment_info', $employee->payment_info) }}</textarea>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-file-alt mr-2"></i>Add More Documents <small class="text-muted">(Optional)</small></h3>
        </div>
        <div class="card-body">
