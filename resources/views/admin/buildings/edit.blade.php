        ...
        <form action="{{ route('admin.buildings.update', $building->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="electricity_type"
                            ...
                            <option value="prepaid" {{ old('electricity_type', $building->electricity_type) == 'prepaid' ? 'selected' : '' }}>Prepaid</option>
                            <option value="postpaid" {{ old('electricity_type', $building->electricity_type) == 'postpaid' ? 'selected' : '' }}>Postpaid</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-switch mb-2">
                            <input type="checkbox" class="custom-control-input" id="water_bill_applicable"
                                ...
                                {{ old('water_bill_applicable', $building->water_bill_applicable) ? 'checked' : '' }}
                        ...
                        <input type="number" name="water_bill_amount" id="water_bill_amount"
                            ...
                            value="{{ old('water_bill_amount', $building->water_bill_amount) }}"
                            placeholder="Amount in BDT"
                            style="{{ old('water_bill_applicable', $building->water_bill_applicable) ? '' : 'display:none' }}">
                        ...
                        @if($building->image)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $building->image) }}"
                                    alt="Building" height="80" class="rounded">
                            </div>
                        @endif
            ...
            <div class="mt-2">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save mr-1"></i> Update Building
                </button>
